...
import Heading from '../../components/@user_type/patient-components/heading.component';
import Tabs from '@mui/material/Tabs';
import Tab from '@mui/material/Tab';
import CustomTabPanel from '../../components/@user_type/patient-components/tab-panel.component';
import UpcomingChanellings from './upcomming-chanellings.page';
import InquiryList from './inq-handle.page';
import PatientDetails from './patient-details.page';
import PrescriptionList from './all-prescriptions.page';
import PatientNavigationBar from '../../views/patient-views/patient-navigation-bar.page';
